...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('mangekamp_event', 'description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Event.location'
        db.alter_column('mangekamp_event', 'location', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Event.location_url'
        db.alter_column('mangekamp_event', 'location_url', self.gf('django.db.models.fields.URLField')(max_length=500, null=True))

    def backwards(self, orm):

        # Changing field 'Event.description'
        db.alter_column('mangekamp_event', 'description', self.gf('django.db.models.fields.TextField')(default='Beskrivelse'))

        # Changing field 'Event.location'
        db.alter_column('mangekamp_event', 'location', self.gf('django.db.models.fields.CharField')(default='Finner sted p\xc3\xa5 <sted>', max_length=100))

        # Changing field 'Event.location_url'
        db.alter_column('mangekamp_event', 'location_url', self.gf('django.db.models.fields.URLField')(default='http://no.capgemini.com', max_length=500))
