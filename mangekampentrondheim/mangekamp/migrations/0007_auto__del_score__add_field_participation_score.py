...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Participation.score'
        db.add_column('mangekamp_participation', 'score',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Participation.score'
        db.delete_column('mangekamp_participation', 'score')
