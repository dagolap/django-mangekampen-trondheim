...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('mangekamp_season', 'title',
                      self.gf('django.db.models.fields.CharField')(default='Best Season Ever', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Season.title'
        db.delete_column('mangekamp_season', 'title')
