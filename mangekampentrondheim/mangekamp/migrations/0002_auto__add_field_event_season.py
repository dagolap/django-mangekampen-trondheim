...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.season'
        db.add_column('mangekamp_event', 'season',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['mangekamp.Season']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.season'
        db.delete_column('mangekamp_event', 'season_id')
