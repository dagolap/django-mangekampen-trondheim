...
DATABASES = {
    'default': {
        ...
        'NAME': 'mangekampen',                      # Or path to database file if using sqlite3.
        'USER': 'mangekampen',                      # Not used with sqlite3.
        'PASSWORD': 'Aevie0up',                  # Not used with sqlite3.
...
STATIC_URL = 'http://static.mk.bitnexus.net:1350/'
